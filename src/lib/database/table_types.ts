 ...
 * $ pg-to-ts generate -c <DATABASE_URL> -t account -t billing_address -t case_color -t case_design -t case_finish -t case_material -t gallery_image -t order -t phone_model -t session -t shipping_address -t user -t verification -s public
 *
 */
