    ...
    return (
        <Dialog open={open} onOpenChange={(v) => !isUploading && setOpen(v)}>
            <DialogTrigger asChild>
                <Button icon={MdAdd} className="h-10">Add image</Button>
            </DialogTrigger>
            ...
            <DialogContent className="sm:max-w-[480px]">
                ...
                <div
                    className={cn(
                        "relative flex min-h-[18rem] w-full flex-col items-center justify-center rounded-md p-2 transition-colors sm:min-h-[22rem]",
                        isDragOver ? "bg-cobalt-tint" : "bg-paper-sunken"
                    )}
                >
